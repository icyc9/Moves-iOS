//
//  MovesSwipeViewController.swift
//  friendly
//
...
class MovesSwipeViewController: SwipeViewController {
    ...
    override func viewDidLoad() {
        ...
        setNavigationWithItem(UIColor.redColor(), leftItem: barButtonItem, rightItem: nil)
    }
